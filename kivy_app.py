...
import json
import os
ALARM_SOUND_PATH = "D:/Downloads/JENNIE - like JENNIE (Official Video)-yt.savetube.me.mp3"  # Default alarm sound path
...
<MainScreen>:
    ...
    BoxLayout:
        ...
        BoxLayout:
            ...
            AsyncImage:
                source: "C:/Users/KRITI KANNAN/Pictures/unity_img.jpg"
                size_hint_y: 0.85
                allow_stretch: True
                keep_ratio: True
                canvas.before:
...
ALARM_SOUND_PATH = "D:/Downloads/JENNIE - like JENNIE (Official Video)-yt.savetube.me.mp3" # Path to alarm sound file
